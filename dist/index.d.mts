...
type WorthyScoreLensName = "composition" | "manufacturing" | "qpr";
...
declare function isSafeHttpsUrl(url: unknown): boolean;
/** affiliate_url è opzionale; se presente deve essere un URL https:// sicuro. */
declare function validateAffiliateUrl(url: string | null | undefined): {
    valid: boolean;
    error?: string;
};
/** Ogni photo_url non vuoto deve essere un URL https:// sicuro. */
declare function validatePhotoUrls(urls: readonly (string | null)[] | null | undefined): {
    valid: boolean;
    error?: string;
};
